...
Accordion.prototype = {
    ...
    openSection: function(section) {
        ...
        if(section.id != this.currentSection) {
			...
			current_index = $(this.currentSection).className.slice(7, 8);
			$(this.currentSection).getOffsetParent().getOffsetParent().select('.opc-titles .step-title-box')[current_index].addClassName('active');
    ...
    closeSection: function(section) {
		...
		remove_index = $(section).className.slice(7, 8);
		$(this.currentSection).getOffsetParent().getOffsetParent().select('.opc-titles .step-title-box')[remove_index].removeClassName('active');
        var contents = Element.select(section, '.a-item');
        contents[0].hide();
